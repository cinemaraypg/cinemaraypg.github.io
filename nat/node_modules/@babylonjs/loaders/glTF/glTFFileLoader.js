    ...
    GLTFFileLoader.prototype.requestFile = function (scene, url, onSuccess, onProgress, useArrayBuffer, onError) {
        ...
        if (useArrayBuffer) {
            if (this.useRangeRequests) {
                ...
                this._unpackBinaryAsync(new DataReader(dataBuffer_1)).then(function (loaderData) {
        ...
        return scene._requestFile(url, function (data, response) {
            _this._validateAsync(scene, data, Tools.GetFolderPath(url), Tools.GetFilename(url));
