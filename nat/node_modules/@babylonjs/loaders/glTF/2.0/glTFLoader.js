...
var GLTFLoader = /** @class */ (function () {
    ...
    GLTFLoader.prototype._loadVertexAccessorAsync = function (context, accessor, kind) {
        ...
        // This prevents certain platforms (e.g. D3D) from having to convert the data to float on the fly.
            ...
            accessor._babylonVertexBuffer = this._loadVertexBufferViewAsync(bufferView_2, kind).then(function (babylonBuffer) {
                ...
                return new VertexBuffer(_this._babylonScene.getEngine(), babylonBuffer, kind, false, false, bufferView_2.byteStride, false, accessor.byteOffset, size, accessor.componentType, accessor.normalized, true);
            });
        }
        return accessor._babylonVertexBuffer;
    };
    ...
    GLTFLoader.prototype._loadTextureAsync = function (context, texture, assign) {
        ...
        var babylonTexture = new Texture(url, this._babylonScene, samplerData.noMipMaps, false, samplerData.samplingMode, function () {
            if (!_this._disposed) {
                deferred.resolve();
            }
    ...
    GLTFLoader.prototype.loadUriAsync = function (context, property, uri) {
        ...
        return this._parent.preprocessUrlAsync(this._rootUrl + uri).then(function (url) {
            return new Promise(function (resolve, reject) {
                if (!_this._disposed) {
                    var request_1 = Tools.LoadFile(url, function (fileData) {
                        if (!_this._disposed) {
                        ...
                        if (!_this._disposed) {
                            ...
                            if (_this._state === GLTFLoaderState.LOADING) {
                                try {
                                    _this._onProgress();
                                }
                                catch (e) {
