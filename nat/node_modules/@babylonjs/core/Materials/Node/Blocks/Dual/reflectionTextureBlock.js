...
var ReflectionTextureBlock = /** @class */ (function (_super) {
    ...
    function ReflectionTextureBlock(name) {
        ...
        _this.registerInput("worldNormal", NodeMaterialBlockConnectionPointTypes.Vector4, false, NodeMaterialBlockTargets.Vertex);
    ...
    ReflectionTextureBlock.prototype._injectVertexCode = function (state) {
        ...
        var worldNormalVaryingName = "v_" + this.worldNormal.associatedVariableName;
    ...
    ReflectionTextureBlock.prototype._buildBlock = function (state) {
        ...
        var worldNormal = "v_" + this.worldNormal.associatedVariableName + ".xyz";
