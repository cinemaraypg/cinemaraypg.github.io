...
var PBRMaterialDefines = /** @class */ (function (_super) {
    ...
    function PBRMaterialDefines() {
        ...
        _this.METALLICF0FACTORFROMMETALLICMAP = false;
...
var PBRBaseMaterial = /** @class */ (function (_super) {
    ...
    function PBRBaseMaterial(name, scene) {
         ...
         */
        _this._useMetallicF0FactorFromMetallicTexture = false;
        /**
    ...
    */
    ...
    PBRBaseMaterial.prototype.forceCompilation = function (mesh, onCompiled, options) {
        ...
        var effect = this._prepareEffect(mesh, defines, undefined, undefined, localOptions.useInstances, localOptions.clipPlane);
        if (effect.isReady()) {
            if (onCompiled) {
                onCompiled(this);
            }
        ...
        if (mustRebind) {
            ...
            if (!ubo.useUbo || !this.isFrozen || !ubo.isSync) {
                ...
                if (defines.METALLICWORKFLOW) {
                    ...
                    var metallicF0 = 0.08 * this._metallicF0Factor;
