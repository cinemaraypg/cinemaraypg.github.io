...
var NativeEngine = /** @class */ (function (_super) {
     ...
     */
    NativeEngine.prototype.createTexture = function (urlArg, noMipmap, invertY, scene, samplingMode, onLoad, onError, buffer, fallback, format, forcedExtension) {
        var _this = this;
        ...
        var onInternalError = function (message, exception) {
            ...
            if (loader) {
                var fallbackUrl = loader.getFallbackTextureUrl(url, textureFormatInUse);
                if (fallbackUrl) {
                    // Add Back
                    customFallback = true;
    ...
    NativeEngine.prototype.createCubeTexture = function (rootUrl, scene, files, noMipmap, onLoad, onError, format, forcedExtension, createPolynomials, lodScale, lodOffset, fallback) {
        ...
        if (extension === ".env") {
            var onloaddata = function (data) {
                ...
                if (!_this._native.loadCubeTexture(texture._webGLTexture, imageData, true)) {
