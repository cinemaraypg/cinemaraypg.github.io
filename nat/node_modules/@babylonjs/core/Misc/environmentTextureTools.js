...
var EnvironmentTextureTools = /** @class */ (function () {
     ...
     */
    EnvironmentTextureTools.CreateImageDataArrayBufferViews = function (arrayBuffer, info) {
        if (info.version !== 1) {
    ...
    EnvironmentTextureTools.UploadEnvLevelsAsync = function (texture, arrayBuffer, info) {
        ...
        var imageData = EnvironmentTextureTools.CreateImageDataArrayBufferViews(arrayBuffer, info);
        ...
        if (expandTexture) {
            ...
            if (generateNonLODTextures) {
                ...
                for (var i = 0; i < mipSlices; i++) {
                    ...
                    engine.updateTextureSamplingMode(11, glTextureFromLod);
