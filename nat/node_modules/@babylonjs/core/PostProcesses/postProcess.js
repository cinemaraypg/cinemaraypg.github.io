    ...
    */
    ...
    PostProcess.prototype.activate = function (camera, sourceTexture, forceDepthStencil) {
        ...
        if (!this._shareOutputWithPostProcess && !this._forcedOutputTexture) {
            ...
            if (this.renderTargetSamplingMode === 3 || this.alwaysForcePOT) {
            ...
            if (this.width !== desiredWidth || this.height !== desiredHeight) {
                ...
                var needMipMaps = this.renderTargetSamplingMode === 3 ||
                    this.renderTargetSamplingMode === 1 ||
                    this.renderTargetSamplingMode === 3 ||
                    this.renderTargetSamplingMode === 6 ||
                    this.renderTargetSamplingMode === 10;
