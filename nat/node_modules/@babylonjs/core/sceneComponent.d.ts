...
export declare class SceneComponentConstants {
    ...
    static readonly STEP_ACTIVEMESH_BOUNDINGBOXRENDERER = 0;
    static readonly STEP_CAMERADRAWRENDERTARGET_EFFECTLAYER = 1;
    static readonly STEP_BEFORECAMERADRAW_EFFECTLAYER = 0;
    static readonly STEP_BEFORECAMERADRAW_LAYER = 1;
    static readonly STEP_BEFORERENDERTARGETDRAW_LAYER = 0;
    static readonly STEP_BEFORERENDERINGMESH_OUTLINE = 0;
    static readonly STEP_AFTERRENDERINGMESH_OUTLINE = 0;
    ...
    static readonly STEP_AFTERRENDERTARGETDRAW_LAYER = 0;
    static readonly STEP_AFTERCAMERADRAW_EFFECTLAYER = 0;
    static readonly STEP_AFTERCAMERADRAW_LENSFLARESYSTEM = 1;
    static readonly STEP_AFTERCAMERADRAW_EFFECTLAYER_DRAW = 2;
    static readonly STEP_AFTERCAMERADRAW_LAYER = 3;
    static readonly STEP_AFTERRENDER_AUDIO = 0;
    static readonly STEP_GATHERRENDERTARGETS_SHADOWGENERATOR = 0;
    static readonly STEP_GATHERRENDERTARGETS_GEOMETRYBUFFERRENDERER = 1;
    static readonly STEP_GATHERRENDERTARGETS_DEPTHRENDERER = 2;
 ...
 */
export declare type ActiveMeshStageAction = (sourceMesh: AbstractMesh, mesh: AbstractMesh) => void;
/**
 ...
 */
export declare type RenderTargetStageAction = (renderTarget: RenderTargetTexture) => void;
/**
 ...
 */
export declare type RenderingMeshStageAction = (mesh: Mesh, subMesh: SubMesh, batch: _InstancesBatch) => void;
/**
 ...
 */
export declare type PointerMoveStageAction = (unTranslatedPointerX: number, unTranslatedPointerY: number, pickResult: Nullable<PickingInfo>, isMeshPicked: boolean, element: HTMLElement) => Nullable<PickingInfo>;
/**
 * Strong typing of a pointer up/down action.
 */
export declare type PointerUpDownStageAction = (unTranslatedPointerX: number, unTranslatedPointerY: number, pickResult: Nullable<PickingInfo>, evt: PointerEvent) => Nullable<PickingInfo>;
/**
