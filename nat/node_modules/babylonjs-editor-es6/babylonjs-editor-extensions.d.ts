...
declare module 'babylonjs-editor-es6' {
    import Extensions from 'babylonjs-editor-es6/extensions';
    import Extension from 'babylonjs-editor-es6/extension';
    import AssetsExtension from 'babylonjs-editor-es6/assets/assets';
    import CodeExtension from 'babylonjs-editor-es6/behavior/code';
    import GraphExtension, { LGraph, LGraphCanvas, LiteGraph, GraphNode, LGraphGroup } from 'babylonjs-editor-es6/behavior/graph';
    import PathFinderExtension from 'babylonjs-editor-es6/path-finder/index';
    import PostProcessEditorExtension from 'babylonjs-editor-es6/post-process-editor/post-process-editor';
    import MaterialEditorExtension from 'babylonjs-editor-es6/material-editor/material-editor';
    import PostProcessExtension from 'babylonjs-editor-es6/post-process/post-processes';
    import CustomMetadatasExtension from 'babylonjs-editor-es6/metadata/metadatas';
    import { IExtension, ExtensionConstructor } from 'babylonjs-editor-es6/typings/extension';
...
declare module 'babylonjs-editor-es6/extensions' {
    import { Scene } from '@babylonjs/core';
    import { IStringDictionary } from 'babylonjs-editor-es6/typings/typings';
    import { IExtension, ExtensionConstructor } from 'babylonjs-editor-es6/typings/extension';
    import Tools from 'babylonjs-editor-es6/tools/tools';
    import Mobile from 'babylonjs-editor-es6/tools/mobile';
...
declare module 'babylonjs-editor-es6/extension' {
    import { Scene } from '@babylonjs/core';
    import { IExtension } from 'babylonjs-editor-es6/typings/extension';
...
declare module 'babylonjs-editor-es6/assets/assets' {
    import { Node, Scene, ParticleSystemSet, Vector3 } from '@babylonjs/core';
    import Extension from 'babylonjs-editor-es6/extension';
    import { AssetElement } from 'babylonjs-editor-es6/typings/asset';
    /**
...
declare module 'babylonjs-editor-es6/behavior/code' {
    import { Scene, AbstractMesh } from '@babylonjs/core';
    import { IStringDictionary } from 'babylonjs-editor-es6/typings/typings';
    import { IAssetComponent, AssetElement } from 'babylonjs-editor-es6/typings/asset';
    import Extension from 'babylonjs-editor-es6/extension';
...
declare module 'babylonjs-editor-es6/behavior/graph' {
    import { Scene, AbstractMesh } from '@babylonjs/core';
    import { LGraph, LGraphCanvas, LiteGraph, LGraphGroup } from 'litegraph.js';
    import Extension from 'babylonjs-editor-es6/extension';
    import { AssetElement } from 'babylonjs-editor-es6/typings/asset';
    import { GraphNode } from 'babylonjs-editor-es6/behavior/nodes/graph-node';
...
declare module 'babylonjs-editor-es6/path-finder/index' {
    import { Scene } from '@babylonjs/core';
    import Extension from 'babylonjs-editor-es6/extension';
    import { IStringDictionary } from 'babylonjs-editor-es6/typings/typings';
    import PathFinder from 'babylonjs-editor-es6/path-finder/path-finder';
...
declare module 'babylonjs-editor-es6/post-process-editor/post-process-editor' {
    import { Scene } from '@babylonjs/core';
    import Extension from 'babylonjs-editor-es6/extension';
    import { IStringDictionary } from 'babylonjs-editor-es6/typings/typings';
    import AbstractPostProcessEditor from 'babylonjs-editor-es6/post-process-editor/post-process';
...
declare module 'babylonjs-editor-es6/material-editor/material-editor' {
    import { Scene } from '@babylonjs/core';
    import Extension from 'babylonjs-editor-es6/extension';
    import { IStringDictionary } from 'babylonjs-editor-es6/typings/typings';
    import CustomEditorMaterial from 'babylonjs-editor-es6/material-editor/material';
...
declare module 'babylonjs-editor-es6/post-process/post-processes' {
    import { Scene, StandardRenderingPipeline, SSAO2RenderingPipeline, DefaultRenderingPipeline } from '@babylonjs/core';
    import Extension from 'babylonjs-editor-es6/extension';
...
declare module 'babylonjs-editor-es6/metadata/metadatas' {
    import { Scene } from '@babylonjs/core';
    import Extension from 'babylonjs-editor-es6/extension';
...
declare module 'babylonjs-editor-es6/typings/extension' {
    import { Scene } from '@babylonjs/core';
    import { IAssetComponent } from 'babylonjs-editor-es6/typings/asset';
    /**
...
declare module 'babylonjs-editor-es6/typings/typings' {
    export interface IStringDictionary<T> {
        [index: string]: T;
    }
}

declare module 'babylonjs-editor-es6/tools/tools' {
    import { Node, Scene, ParticleSystem, ParticleSystemSet, Vector3 } from '@babylonjs/core';
    import PathFinder from 'babylonjs-editor-es6/path-finder/path-finder';
...
declare module 'babylonjs-editor-es6/tools/mobile' {
...
declare module 'babylonjs-editor-es6/typings/asset' {
    import { AbstractMesh, PickingInfo } from '@babylonjs/core';
...
declare module 'babylonjs-editor-es6/behavior/nodes/graph-node' {
    import { Scene, Node, Vector3, Vector2, Vector4, Color3, Color4 } from '@babylonjs/core';
    import { LGraphCanvas } from 'litegraph.js';
    import { IGraphNode, IGraphNodeDescriptor } from 'babylonjs-editor-es6/behavior/nodes/types';
    /**
...
declare module 'babylonjs-editor-es6/path-finder/path-finder' {
    import { Vector3, BoundingInfo, AbstractMesh, Animation } from '@babylonjs/core';
...
declare module 'babylonjs-editor-es6/post-process-editor/post-process' {
    import { PostProcess, Effect, Scene, Camera, BaseTexture, Engine, Vector2, Vector3 } from '@babylonjs/core';
    /**
...
declare module 'babylonjs-editor-es6/material-editor/material' {
    import { Scene, MaterialDefines, PushMaterial, Nullable, BaseTexture, Color3, Matrix, Vector2, Vector3, AbstractMesh, SubMesh, Mesh, IAnimatable, Effect } from '@babylonjs/core';
    /**
...
declare module 'babylonjs-editor-es6/behavior/nodes/types' {
    import { Scene, Vector2, Vector3, Vector4 } from '@babylonjs/core';
